    ...
    >
      <div className="flex h-fit w-full justify-start">
        <button
          ...
          className="flex items-center justify-center rounded-lg border border-white bg-white px-2 text-lg text-gray-500 transition-all hover:border-gray-200 hover:bg-gray-100"
        >
          x
        </button>
      </div>
